  ...
  return (
    <div className="px-5 py-3">
      <div className="max-w-lg mx-auto">
        <h2 className="text-lg font-bold text-[#2f1b0e] mb-3">Öne Çıkanlar</h2>
        <div className="flex gap-3 overflow-x-auto pb-3 scrollbar-hide">
          {featuredItems.map((item) => (
            <div key={item.id} onClick={() => onProductClick(item)} className="group flex-shrink-0 w-40 cursor-pointer">
              <div className="rounded-3xl overflow-hidden bg-white border border-[#ecdcca] shadow-[0_8px_20px_rgba(30,15,0,0.08)] hover:shadow-[0_10px_28px_rgba(30,15,0,0.12)] transition-all duration-300">
